...
recovery_df = CountryAnalysis.compute_recovery_rate(country_latest_df)
best_df, worst_df = CountryAnalysis.get_recovery_extremes(recovery_df)
print("\nBest Recovery Countries")
best_df.show(truncate=False)
